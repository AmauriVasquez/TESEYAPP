...
import FormatoOCTESEY from '@/components/formatos/FormatoOCTESEY';
import FormatoOCIIHEMSA from '@/components/formatos/FormatoOCIIHEMSA';
        ...
        {!selectedFormat ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-8">
            ...
            >
                ...
                <h3 className="text-xl font-bold text-gray-800">Formato IIHEMSA Peninsular</h3>
                <p className="text-center text-gray-500 mt-2 text-sm">Imprimir con logo y datos fiscales de IIHEMSA Peninsular.</p>
            </div>
          ...
          <div className="flex justify-center py-4 bg-gray-100 rounded-lg">
              {selectedFormat === 'TESEY' && <FormatoOCTESEY data={pedidoData} />}
              {selectedFormat === 'IIHEMSA' && <FormatoOCIIHEMSA data={pedidoData} />}
          </div>
        )}
      </DialogContent>
    </Dialog>
